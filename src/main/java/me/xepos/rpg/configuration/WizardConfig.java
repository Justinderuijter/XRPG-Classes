...
public final class WizardConfig extends XRPGConfigFile {
    ...
    public void loadValues()
    {
        ...
        meteorDamageBlocks = get().getBoolean("meteorDamageBlocks", true);
        meteorSetFire = get().getBoolean("meteorSetFire", true);
    ...
    public void setDefaults()
    {
        ...
        get().addDefault("meteorDamageBlocks", true);
        get().addDefault("meteorSetFire", true);
