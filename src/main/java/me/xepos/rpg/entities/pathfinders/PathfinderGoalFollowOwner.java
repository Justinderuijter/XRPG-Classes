...
public class PathfinderGoalFollowOwner extends PathfinderGoal {
    ...
    public PathfinderGoalFollowOwner(Follower follower, double d0, float f, float f1, boolean flag) {
        ...
        this.d = d0;
        this.e = follower.getNavigation();
        this.h = f; //Wak distance
        this.g = f1; //Teleport distance
        this.j = flag;
        this.a(EnumSet.of(Type.MOVE, Type.LOOK));
        if (!(follower.getNavigation() instanceof Navigation) && !(follower.getNavigation() instanceof NavigationFlying)) {
            throw new IllegalArgumentException("Unsupported mob type for FollowOwnerGoal");
        }
    }

    public boolean a() {
        EntityLiving entityliving = ((CraftLivingEntity)this.a.getOwner()).getHandle();
    ...
    public boolean b() {
        return !this.e.m() && (this.a.h(this.b) > (double) (this.g * this.g));
    }
